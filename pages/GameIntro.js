...
function GamePage(){
    ...
    return(
        ...
        <input 
          ...
          />   <br></br><br></br>
          <Link href="/GameIntro2">
          <button  className= "bg-slate-900  text-white font-bold py-2 px-4 border border-black-700 rounded hover:bg-slate-600  hover:text-white rounded-full" id="sbmitbtn" type="submit">SUBMIT </button>
          </Link></div>
